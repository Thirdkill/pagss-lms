...
<head>
	...
	<title>PAGSS - EDIT EVALUATION</title>
	<!-- START: CSS-HEADER -->
...
<body>
	...
	<div id="evalProfileBody" class="container2">
            ...
            <div class="divcard">
              <div class="row">
                <div class="col s12 m5">
                  ...
                  <input id="evaluationCodeTxtbox" type="text" name="" disabled="disabled" class="validate">
                </div>
        ...
        <div id="addSectionModal" class="modal modal-fixed-footer fixed-modal">
