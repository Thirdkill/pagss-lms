          ...
          <div class="divcard">
            ...
            <div class="row" >
              ...
              <div class="col s12 m4">
                <span style="color:#1e88e5;font-family: 'Staatliches', cursive;font-size: 1.64rem; ">Passenger Handling</span> <span>(MTC0001)</span>
                <hr>
                <div>
            ...
            <div class="row" id="documentViewerCon">
              <center><iframe src="${contentUrl}"id="documentViewerFrame" width='1000' height='700' allowfullscreen webkitallowfullscreen></iframe></center>
            </div>
